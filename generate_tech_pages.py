...
# 4. SEO Variations
title_templates = [
    "Expert [SERVICE] in [CITY], [STATE] | Deans Handyman Service",
    "Top-Rated [SERVICE] - [CITY] | Fast & Reliable",
    "[CITY]'s Best [SERVICE] | Professional Handyman",
    "Affordable [SERVICE] in [CITY], [STATE] | Call Today"
]

desc_templates = [
    "Looking for [SERVICE] in [CITY], [STATE]? Deans Handyman Service LLC provides professional, fast, and reliable help. Call 281-917-9914 today!",
    "Get expert [SERVICE] done right in [CITY]. We are your local, trusted professionals at Deans Handyman Service LLC.",
    "Need help with [SERVICE]? We serve the [CITY], [STATE] area with top-tier handyman and technical services. Contact us for a free quote.",
    "Deans Handyman Service LLC offers highly-rated [SERVICE] throughout [CITY]. Fast scheduling and quality workmanship guaranteed."
]

# 5. Full HTML Template (Matching your index.html perfectly with fixed ../ links)
...
<body>
    ...
    <main>
        <section class="hero">
            <div class="container hero-layout">
                <div class="hero-text" data-aos="fade-right">
                    <div style="background: rgba(34,197,94,0.2); color: var(--trust-green); padding: 0.5rem 1rem; border-radius: 50px; display: inline-block; font-weight: 700; margin-bottom: 1.5rem; font-size: 0.9rem;">
                        ⭐ 5-Star Rated • Tech & Repair Specialist
                    </div>
                    <h1>[SERVICE] in [CITY], [STATE]</h1>
                    <p>[META_DESCRIPTION]</p>
                    
                    <div class="trust-badges">
                        <div class="trust-badge">📡 Local Expert</div>
                        <div class="trust-badge">🛠️ Professional Service</div>
                    </div>

                    <ul>
                        <li>Locally owned and operated serving [CITY], [STATE].</li>
                        <li>Professional, communicative, and timely service.</li>
                        <li>Backed by years of technical and construction experience.</li>
                    </ul>
                </div>

                <div class="lead-card" id="contact" data-aos="fade-left">
                    <h3 style="text-align: center; margin-bottom: 0.5rem;">Request a Free Quote</h3>
                    <p style="text-align: center; font-size: 0.9rem; color: #666; margin-bottom: 1.5rem;">Fill this out and I'll text/call you to discuss your [SERVICE].</p>
                    
                    <form id="quoteForm" action="https://formsubmit.co/deanshandymanservice1@gmail.com" method="POST" enctype="multipart/form-data">
                        
                        <input type="hidden" name="_subject" value="🚨 NEW VETTED LEAD ([CITY] Service Page)">
                        <input type="hidden" name="_next" value="https://calendar.app.google/wAGf72SYFC5io4nV9">
                        <input type="hidden" name="_captcha" value="false">
                        <input type="hidden" name="_template" value="table">
                        <input type="hidden" name="_autoresponse" value="Thanks for reaching out! I've received your details. Please pick a time on my calendar for a quick call. - Dean">
                        ...
                        <div class="form-group">
                            ...
                            <select id="service" name="Service_Requested" required>
                                ...
                                <option>Starlink Installation</option>
                                <option>Wi-Fi / Network Setup</option>
                                <option>Smart Home / Security Cameras</option>
                                <option>Electrical / Wiring</option>
                                <option>Handyman / General Repair</option>
                            </select>
                        </div>
                        ...
                        <button type="submit" id="submitBtn" class="btn btn-accent" style="width:100%; font-size: 1.2rem;">Check Availability & Get Quote</button>
                    </form>
                </div>
            </div>
        </section>
        ...
        <section class="section" style="background: var(--dark); padding-top: 60px; padding-bottom: 60px;">
            <div class="container">
                <h2 style="color: white; text-align: center;">Frictionless Payments</h2>
    ...
    <script>
        ...
        document.getElementById('quoteForm').addEventListener('submit', function(e) {
            ...
            const noteBody = `🚨 NEW LEAD ([CITY] Page)!\n\nName: ${name}\nEmail: ${email}\nPhone: ${phone}\nService: ${service}\nLocation: ${address}\nDetails: ${details}`;
...
for service in services:
    for city_data in cities:
        ...
        meta_title = random.choice(title_templates).replace("[SERVICE]", service).replace("[CITY]", city).replace("[STATE]", state)
        meta_description = random.choice(desc_templates).replace("[SERVICE]", service).replace("[CITY]", city).replace("[STATE]", state)
        ...
        # String replacement (Prevents {}, CSS, and JS from crashing Python)
        ...
        page_content = page_content.replace("[SERVICE]", service)
